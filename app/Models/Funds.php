...
class Funds extends Model
{
    ...
    protected $fillable = ['userId', 'businessId', 'amount', 'description', 'address', 'type', 'existingLoan', 'certifyGuarantor', 'certifyDocuments', 'hasPaidReg', 'transactionId', 'progress', 'isOpen', 'message'];
