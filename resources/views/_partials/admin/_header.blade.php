        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                <div class="kt-header__topbar-user">
                    ...
                    <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold">{{$user->name[0]}}</span>
                </div>
            </div>
        </div>
        <div class="kt-header__topbar-item kt-header__topbar-item--search dropdown" id="kt_quick_search_toggle">
            <div class="kt-header__topbar-wrapper" data-offset="10px,0px">
                <a href="{{URL('/logout')}}" class="kt-header__topbar-icon">
                ...
                <a class="mt-4 mx-2" href="{{URL('/logout')}}">Logout</a>
            </div>
        </div>
    </div>
</div>
