<div class="main-menu menu-static menu-light menu-accordion menu-shadow border-radius-10" data-scroll-to-active="true">
    <div class="main-menu-content border-radius-10">
        <ul class="navigation navigation-main border-radius-10" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @else
                <li class=" nav-item">
                    <a href="{{URL('dashboard/i/investments')}}">
                        @endif
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-title" data-i18n="nav.templates.main">Investments</span>
                    </a>
                </li>
...
{{--                            </svg>--}}
{{--                        </i>--}}
{{--                        <span class="menu-title" data-i18n="nav.templates.main">Notifications</span></a>--}}
{{--                </li>--}}


                <li class=" navigation-header">
                    <span data-i18n="nav.category.layouts">Account</span><i class="la la-ellipsis-h ft-minus" data-toggle="tooltip"
                                                                            data-placement="right" data-original-title="Layouts"></i>
                </li>

            @if(Request::is('dashboard/i/share*'))
                <li class=" nav-item open">
                    <a href="{{URL('dashboard/i/share')}}" class="active">
            @else
                <li class=" nav-item">
                    <a href="{{URL('dashboard/i/share')}}">
            @endif
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-title" data-i18n="nav.page_layouts.main">Referral</span>
                    </a>
                </li>


            @if(Request::is('dashboard/i/settings*'))
                <li class=" nav-item open">
                    <a href="{{URL('dashboard/i/settings')}}" class="active">
            @else
                <li class=" nav-item">
                    <a href="{{URL('dashboard/i/settings')}}">
            @endif
                    <i>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-title" data-i18n="nav.navbars.main">Settings</span></a>
                </li>
        </ul>
    </div>
</div>
