<div class="main-menu menu-static menu-light menu-accordion menu-shadow border-radius-10" data-scroll-to-active="true">
    <div class="main-menu-content border-radius-10">
        <ul class="navigation navigation-main border-radius-10" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if(Request::is('dashboard/e'))
            <li class=" nav-item open">
                <a href="{{URL('dashboard/e')}}" class="active">
            @else
            <li class=" nav-item">
                <a href="{{URL('dashboard/e')}}">
            @endif
                    <i>
            ...
            @if(Request::is('dashboard/e/businesses*'))
            <li class=" nav-item open">
                <a href="{{URL('dashboard/e/businesses')}}" class="active">
            @else
            <li class=" nav-item">
                <a href="{{URL('dashboard/e/businesses')}}">
            @endif
                    <i>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-title" data-i18n="nav.templates.main">Businesses</span>
                </a>
            </li>

            @if(Request::is('dashboard/e/document*'))
            <li class=" nav-item open">
                <a href="{{URL('dashboard/e/document')}}" class="active">
            @else
            <li class=" nav-item">
                <a href="{{URL('dashboard/e/document')}}">
            @endif
                    <i>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            @if(Request::is('dashboard/e/settings*'))
            <li class=" nav-item open">
                <a href="{{URL('dashboard/e/settings')}}" class="active">
            @else
            <li class=" nav-item">
                <a href="{{URL('dashboard/e/settings')}}">
            @endif
                    <i>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-title" data-i18n="nav.navbars.main">Settings</span>
                </a>
            </li>
        </ul>
    </div>
