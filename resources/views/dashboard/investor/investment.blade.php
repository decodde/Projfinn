...
{{--                                        <path d="M20.4061385,6.73606154 C20.7672665,6.89656288 21,7.25468437 21,7.64987309 L21,16.4115967 C21,16.7747638 20.8031081,17.1093844 20.4856429,17.2857539 L12.4856429,21.7301984 C12.1836204,21.8979887 11.8163796,21.8979887 11.5143571,21.7301984 L3.51435707,17.2857539 C3.19689188,17.1093844 3,16.7747638 3,16.4115967 L3,7.64987309 C3,7.25468437 3.23273352,6.89656288 3.59386153,6.73606154 L11.5938615,3.18050598 C11.8524269,3.06558805 12.1475731,3.06558805 12.4061385,3.18050598 L20.4061385,6.73606154 Z" fill="#d2081f" opacity="0.3"/>--}}
{{--                                        <polygon fill="#d2081f" points="14.9671522 4.22441676 7.5999999 8.31727912 7.5999999 12.9056825 9.5999999 13.9056825 9.5999999 9.49408582 17.25507 5.24126912"/>--}}
{{--                                    </g>--}}
{{--                                </svg>--}}
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="34px" height="34px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="heading-elements">
                        ...
                        <ul class="list-inline mb-0">
                            <li>
                                <a>
                                    <i class="position-relative green success"  style="top: 5px;">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title blue-grey font-weight-bold darken-3">Working Capital Portfolio</h4>
                        <div class="card-text">
                            <hr>
                            <dl class="row py-1">
                        ...
                        <a href="{{URL('/dashboard/i/investment')}}" class="btn btn-link info ">More Details <i class="ft-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title blue-grey font-weight-bold darken-3">Asset Finance Portfolio</h4>
                        <div class="card-text">
                            <hr>
                            <dl class="row py-1">
                                <dt class="col-md-9 text-muted font-weight-normal" >Amount per Unit</dt>
                        ...
                        <a href="#" class="btn btn-link info">More Details <i class="ft-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
