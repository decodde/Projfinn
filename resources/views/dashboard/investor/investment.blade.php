                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($investment->isOpen === "true")
                                                    ...
                                                    <a class="btn btn-blue border-0 box-shadow-2 text-white" href="javascript:void(0);" onclick="window.alert('Your invest will be matured after 90days from Investment');">
                                                        @else
