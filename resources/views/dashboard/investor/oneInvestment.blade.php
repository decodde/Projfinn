                            ...
                            <fieldset class="mt-1">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><code>Note:</code> <a class="grey-blue darken-3">{{$portfolio->unitsLeft}}</a> units are left in this portfolio</p>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control required"  min="1" max="{{$portfolio->unitsLeft}}" id="units" name="unitsBought">
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
