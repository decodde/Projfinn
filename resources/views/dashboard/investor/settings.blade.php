                ...
                <div class="card-content">
                    ...
                    <div class="card-body">
                        @if($accountDetails !== null)
                            <form action="{{ URL('account/updateDetails') }}" method="POST" onsubmit="return checkNumberLength(event);" id="bvnForm">
                        @else
                            <form action="{{ URL('account/create') }}" method="POST" onsubmit="return checkNumberLength(event);" id="bvnForm">
                        @endif
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                                <input type="hidden" name="userId" value="{{ $user->id }}">
                                @if($accountDetails !== null)
